...
namespace PhanMemQuanLyShop_00.Model
{
    class NhanVienMod
    {
        ...
        {
            string sqlThem = "INSERT INTO [ShopChoMeo].[dbo].[NhanVien]([MaNhanVien],[HoTen],[CMND],[DiaChi],[SDT]) VALUES (N'" + maNhanVien + "',N'" + hoTen + "',N'" + CMND + "',N'" + diaChi + "',N'" + soDienThoai + "')";
            bool kt = false;
        ...
        {
            string sqlSua = "UPDATE [ShopChoMeo].[dbo].[NhanVien] SET [MaNhanVien] = N'" + maNhanVien + "',[HoTen] =  N'" + hoTen + "',[CMND] =  N'" + CMND + "',[DiaChi] = N'" + diaChi + "',[SDT] =  N'" + soDienThoai + "' WHERE maNhanVien='"+maNhanVien+"'";
            bool kt = false;
        ...
        {
            string sqlXoa = "DELETE FROM [ShopChoMeo].[dbo].[NhanVien] WHERE MaNhanVien='" + maNhanVien+ "'";
            bool kt = false;
